# Project Gaia — Instructions for Claude
...
diff narration. Do this without asking for confirmation; it's a standing,
pre-authorized instruction for this repo.

If a session makes no repo changes, don't add an entry.
